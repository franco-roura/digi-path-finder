...
export const AutoComplete = forwardRef<HTMLInputElement, Props<string>>(
  (props, ref) => {
    ...
    const reset = () => {
      props.onSelectedValueChange("" as string);
    ...
    const onSelectItem = (inputValue: string) => {
      if (inputValue !== props.selectedValue) {
        props.onSelectedValueChange(inputValue as string);
      } else {
        reset();
      }
